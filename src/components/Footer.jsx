...
const Footer = () => {
  return (
    <div className=' flex gap-5 w-full h-screen p-20  font-[MADE Outer Sans Alt]'>
        <div className="w-1/2 h-full flex flex-col justify-between ">
            <div className="heading">
            <h1 className='text-[9vw] font-semibold uppercase leading-none -mb-10'>Eye-</h1>
            <h1 className='text-[9vw] font-semibold uppercase leading-none -mb-10'>Opening</h1>
            </div>
            <div className="svg">
